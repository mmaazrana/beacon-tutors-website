            ...
            <div className = {styles.main}>
                ...
                <div className = {styles.wrapper}>
                    ...
                    <div className = {styles.lottieRow}>
                        ...
                        {KarachiSelected && <CSSTransition
                            in = {KarachiSelected}
                            appear = {true}
                            timeout = {1000}
                            classNames = {selectAlternateAnimationStyles}>
                            <div>
                                <Karachi className = {KarachiLottieClass}/>
                            </div>
                        </CSSTransition>} {IslamabadSelected &&
                        <CSSTransition
                            in = {IslamabadSelected}
                            appear = {true}
                            timeout = {1000}
                            classNames = {selectAlternateAnimationStyles}>
                        <div>
                            <Islamabad className = {IslamabadLottieClass}/>
                        </div>
                        </CSSTransition>
                    } {LahoreSelected &&
                        <CSSTransition
                            ...
                            classNames = {selectAlternateAnimationStyles}>
                        <div>
                            <Lahore className = {LahoreLottieClass}/>
                        </div>
                        </CSSTransition>
                    } {RawalpindiSelected &&
                        <CSSTransition
                            in = {RawalpindiSelected}
                            appear = {true}
                            timeout = {1000}
                            classNames = {selectAlternateAnimationStyles}>
                        <div>
                            <Rawalpindi className = {RawalpindiLottieClass}/>
                        </div>
                        </CSSTransition>
                    } {OtherSelected &&
                        <CSSTransition
                            ...
                            classNames = {selectAlternateAnimationStyles}>
                        <div>
                            <Other className = {OtherLottieClass}/>
                        </div>
                        </CSSTransition>
                    }
                    ...
                    <div className = {styles.row}>
                        <button onClick = {setKarachiActive} className = {KarachiClass}>Karachi</button>
                        <button onClick = {setIslamabadActive} className = {IslamabadClass}>Islamabad</button>
                        <button onClick = {setLahoreActive} className = {LahoreClass}>Lahore</button>
                        <button onClick = {setRawalpindiActive} className = {RawalpindiClass}>Rawalpindi</button>
                        <button onClick = {setOtherActive} className = {OtherClass}>Other</button>
                    </div>

                </div>
                <div className = {styles.singleButton}>
                <CSSTransition
                    in = {KarachiSelected || LahoreSelected || RawalpindiSelected || IslamabadSelected || OtherSelected}
                    appear = {KarachiSelected || LahoreSelected || RawalpindiSelected || IslamabadSelected || OtherSelected}
                    timeout = {1000}
                    classNames = {fadeAnimationStyles}>
                    <div className = {styles.nextButton}>
                        {(KarachiSelected || LahoreSelected || RawalpindiSelected || IslamabadSelected || OtherSelected) &&
                            <LinkButton text = {"Next"} link = {"/selectservice"} primary = {true}/>
                        }
                    </div>
                </CSSTransition>
                </div>
